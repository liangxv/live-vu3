<template>
    <div class="recharge">
        ...
        <van-popup v-model:show="showPaymentPopup" position="bottom">
            <van-picker v-model="paymentMethods" :columns="paymentMethods" @cancel="closePaymentMethods"
                @confirm="selectPaymentMethod"></van-picker>
        </van-popup>
...
<script setup>
import { ref } from 'vue';
import { recharged } from '@/api/recharge.js';
